...
### 3.2 Requisitos Não-Fundionais (RNF)
...
graph TD
    ...
    UC3 --> |Include| UC5[Visualizar Histório de Consultas]
...
graph TD
    ...
    C --> D["Preencher: Serviço, Data/Hora e Observações"]
    D --> E{"Campos obrigatórios preenchidos?"}
    E -- Não --> F["Exibir alerta de erro na tela"]
    F --> D
    E -- Sim --> G["Acionar ConsultaController.salvar()"]
    G --> H["Chamar DatabaseHelper.insertConsulta()"]
    H --> I["Gravar registro na tabela 'consultas' (SQLite)"]
